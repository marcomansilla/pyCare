# -*- coding: utf-8 -*-
"""WSGI middleware initialization for the pyCare application."""

from pycare.config.app_cfg import base_config
from pycare.config.environment import load_environment
